...
public class RMIClient extends UnicastRemoteObject implements RMI_C {
     ...
     * @author Rodrigo Martins
     */
    public String sendToClient(ArrayList<String> message) throws java.rmi.RemoteException{
     ...
     * @throws java.rmi.RemoteException gets caught outside of the scope.
     *
     * @author Rodrigo Martins
     */
    private void searchWords(Scanner scan, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void registerUser(Scanner scan, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void loginUser(Scanner scan, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void searchUrlReferences(Scanner scan, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void searchHistory(Scanner scan, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @throws java.rmi.RemoteException gets caught outside of the scope.
     * @throws java.rmi.NotBoundException gets caught outside of the scope.
     *
     * @author Rodrigo Martins
     */
    private RMI_S connectToServer() throws java.rmi.RemoteException, java.rmi.NotBoundException{
     ...
     * @author Rodrigo Martins
     */
    private void indexUrl(Scanner scan, int clientId, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void giveUserAdminPrivileges(Scanner scan, int clientId, RMI_S server) throws java.rmi.RemoteException{
     ...
     * @author Rodrigo Martins
     */
    private void showAdminPage(Scanner scan, int clientId, RMI_S server) throws java.rmi.RemoteException{
