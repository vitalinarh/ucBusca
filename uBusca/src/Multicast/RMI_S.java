...
public interface RMI_S extends Remote {
     ...
     */
    int getServerPID() throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    int subscribe(RMI_C client, int clientId) throws java.rmi.RemoteException;
     ...
     */
    int[] login(String username, String password, int clientId, RMI_C client) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    int register(String username, String password, int clientId) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    String searchWords(String searchQuery, int clientId) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    String searchPagesConnectedToPage(String searchQuery, int clientId) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    String getSearchHistory(int clientId) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    String adminIndexUrl(String urlToIndex, int clientId) throws java.rmi.RemoteException;
     ...
     * @throws RemoteException
     */
    String adminGetAdminPage(int clientId) throws java.rmi.RemoteException;
     ...
     * @author Rodrigo Martins
     */
    int adminGiveAdminPrivilege(String username, int clientId) throws java.rmi.RemoteException;
}
